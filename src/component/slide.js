     ...
     <section className="pb-20 bg-blueGray-200  text-white bg-Teal" >
          <div className="container mx-auto px-4 ">
           ...
           About Us
            ...
            Our hostel has single beds, double beds, and twin beds, as well as a conference halls and bar-restaurant to meet your needs. Our bar and restaurant offer fresh food with several menu options for you to choose from.</p>
